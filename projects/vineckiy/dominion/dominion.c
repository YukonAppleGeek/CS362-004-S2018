...
int adventurerCardEffect(struct gameState *state, int currentPlayer) {
    int i = 0, drawnTreasure = 0, cardDrawn, tempHand[MAX_HAND];
...
int feastCardEffect(struct gameState *state, int currentPlayer, int choice1) {
    ...
    int i, canBuy, tempHand[MAX_HAND];
    //Backup hand
    for (i = 0; i <= state->handCount[currentPlayer]; i++) {
        //Backup card
...
int mineCardEffect(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2) {
    int i, trashCard;
    //store card we will trash
    trashCard = state->hand[currentPlayer][choice1];
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
    ...
    switch (card) {
        ...
        case mine:
            return mineCardEffect(state, currentPlayer, handPos, choice1, choice2);
